...
-(void) initializationComplete
{
	...
	config.supportsInterfaceOrientationPortrait = NO;
	config.supportsInterfaceOrientationPortraitUpsideDown = NO;
	config.supportsInterfaceOrientationLandscapeLeft = NO;
